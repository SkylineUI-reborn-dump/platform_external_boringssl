...
LOCAL_MODULE := libcrypto_1010107f_static
...
include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libcrypto_1010107f
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/src/include
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/Android.mk $(LOCAL_PATH)/crypto-sources.mk
LOCAL_SDK_VERSION := 9
LOCAL_CFLAGS := $(boringssl_cflags)
...
LOCAL_MODULE := bssl_1010107f
LOCAL_MODULE_TAGS := eng
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/Android.mk $(LOCAL_PATH)/sources.mk
LOCAL_CFLAGS := $(boringssl_cflags)
LOCAL_CPPFLAGS := $(boringssl_cppflags)
LOCAL_CONLYFLAGS := $(boringssl_conlyflags)
LOCAL_SHARED_LIBRARIES=libcrypto_1010107f libssl_1010107f
...
include $(CLEAR_VARS)
LOCAL_IS_HOST_MODULE := true
LOCAL_MODULE := libcrypto_1010107f_static-host
LOCAL_MODULE_HOST_OS := darwin linux windows
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/src/include
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/Android.mk $(LOCAL_PATH)/crypto-sources.mk
LOCAL_CFLAGS := $(boringssl_cflags)
...
include $(CLEAR_VARS)
LOCAL_IS_HOST_MODULE := true
LOCAL_MODULE := libcrypto_1010107f-host
...
include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libssl_1010107f_static
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/src/include
...
include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libssl_1010107f
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/src/include
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/Android.mk $(LOCAL_PATH)/ssl-sources.mk
LOCAL_CFLAGS := $(boringssl_cflags)
LOCAL_CPPFLAGS := $(boringssl_cppflags)
LOCAL_CONLYFLAGS := $(boringssl_conlyflags)
LOCAL_SHARED_LIBRARIES=libcrypto_1010107f
LOCAL_SDK_VERSION := 9
include $(LOCAL_PATH)/ssl-sources.mk
include $(BUILD_SHARED_LIBRARY)
...
include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libssl_1010107f_static-host
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/src/include
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/Android.mk $(LOCAL_PATH)/ssl-sources.mk
LOCAL_CFLAGS := $(boringssl_cflags)
LOCAL_CPPFLAGS := $(boringssl_cppflags)
...
LOCAL_CPPFLAGS := $(boringssl_cppflags)
LOCAL_CONLYFLAGS := $(boringssl_conlyflags)
LOCAL_SHARED_LIBRARIES=libcrypto_1010107f-host libssl_1010107f-host
...
include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libssl_1010107f-host
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/src/include
LOCAL_MULTILIB := both
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/Android.mk $(LOCAL_PATH)/ssl-sources.mk
LOCAL_CFLAGS := $(boringssl_cflags)
...
LOCAL_CONLYFLAGS := $(boringssl_conlyflags)
LOCAL_CXX_STL := none
LOCAL_SHARED_LIBRARIES += libcrypto_1010107f-host
include $(LOCAL_PATH)/ssl-sources.mk
include $(BUILD_HOST_SHARED_LIBRARY)
